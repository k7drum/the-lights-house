...
const sidebarItems = [
  ...
  {
    section: "Settings",
    items: [{ name: "Settings", href: "/admin/dashboard/settings", icon: Settings }],
  },
];
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:relative z-40 lg:z-auto w-64 bg-gray-800 h-screen lg:h-full p-4 flex flex-col justify-between transform transition-transform ${
          isOpen ? "translate-x-0" : "-translate-x-64"
        } lg:translate-x-0`}
      >
        {/* Logo */}
        <div className="text-center mb-6 flex flex-col items-center">
          <Image src="/logo.png" alt="Logo" width={50} height={50} className="mb-2" />
          ...
          <ul className="space-y-3">
            {sidebarItems.map((section) => (
              <li key={section.section}>
                <h3 className="text-gray-400 text-sm uppercase font-semibold px-2 mt-4">
                  {section.section}
                </h3>
